...
public class FolderSelectionUI extends JDialog {
    ...
    public FolderSelectionUI(SNClient SNClient, Project project, String selectedEnvironment) {
...
//                parentFolderId = null;
//            }
//            folderResults = this.SNClient.getSubFolders(parentFolderId);
//        } catch (Exception ex) {
...
//        }
    ...
    private void saveProjectSettings(String nsRootFolderId) {
        ...
        nsProjectSettingsController.setNsEmail(this.SNClient.getNSAccount().getAccountEmail());
        nsProjectSettingsController.setNsAccount(this.SNClient.getNSAccount().getAccountId());
        nsProjectSettingsController.setNsAccountName(this.SNClient.getNSAccount().getAccountName());
        nsProjectSettingsController.setNsEnvironment(this.url);
        nsProjectSettingsController.saveProjectPassword(this.SNClient);
    }
